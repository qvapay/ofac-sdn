...
export default function OFACChecker() {
  ...
  const performSearch = async () => {
    ...
    try {
      ...
      if (!response.ok) { throw new Error(data.error || 'Failed to perform search') }
      const searchResult = {
      ...
      setResult({ type: "error", name: searchTerm, message: "An error occurred while searching. Please try again." })
    } finally {
              ...
              <div className="max-w-2xl mx-auto">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-14 pr-4 py-6 text-lg text-gray-900 rounded-2xl border-2 border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      <footer className="mt-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center text-sm text-gray-500">
            <p>© {new Date().getFullYear()} OFAC SDN Screening Tool.</p>
            <p className="mt-2">
